function obj = init_model(obj)
    ...
    % mean
    % ----
    format = brca.format.auto(obj.mu0);
    if ~isfinite(obj.nm0)
        obj.mu = obj.mu0;
    else
    ...
    if ~isfinite(obj.nl) || obj.nl == 0
        ...
        obj.loglam = log(obj.lam) ...
                     + brca.utils.diGamma(0.5*obj.nl*D) ...
                     - log(0.5*obj.nl*D);
    end
    ...
    format = brca.format.auto(obj.U0);
    ...
    obj.A  = obj.A0;
    obj.nA = obj.nA0;
    obj.logA = brca.utils.logdetPD(obj.A);
    if obj.nA0 > 0
        obj.logA = obj.logA ...
                    + brca.utils.diGamma(0.5*obj.nA, obj.M) ...
                    - obj.M * log(obj.nA) ...
                    + obj.M * log(2);
    end
